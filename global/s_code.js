...
if(cur_url.indexOf('loc.gov/staff')>-1||cur_url.indexOf('loc.gov/extranet')>-1||cur_url.indexOf('col=staff')>-1||cur_url.indexOf('staff.loc.gov')>-1) s_account="locintranetprod";
...
function s_doPlugins(s) {
    ...
    s.prop9=s.eVar19="PROD24MAY2011WR";
    ...
    if(s.prop2) {
        ...
        if(s.currentURL) {
            ...
            else if(s.currentURL.indexOf('loc.gov/search')>-1) s.prop3="fedsearch";
    ...
    if(window['doSiteMetricsPlugin']){
        try{
            doSiteMetricsPlugin(s);
        }catch(e){
            //swallow
        }
    }
