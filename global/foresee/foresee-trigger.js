...
var FSR = {
	...
	'auto' : true,
	'encode' : true,
    'files': '//cdn.loc.gov/js/global/foresee/',
    'id': 'Zg8xEcQ4h9p0s15J1kVshg==',
    'sites': [{
...
},onMouseover:function(){this.className="fsr_closeSticky fsr_button fsr_mouseover_decline"},onFocus:function(){this.className="fsr_closeSticky fsr_button fsr_mouseover_decline"
},onMouseout:function(){this.className="fsr_closeSticky fsr_button fsr_decline"},onBlur:function(){this.className="fsr_closeSticky fsr_button fsr_decline"
}};B++}if(I.buttons.accept){G[B]={properties:{id:"accept"},style:"fsr_button fsr_accept",text:I.buttons.accept,onClick:function(){L[D]()
},onMouseover:function(){this.className="fsr_closeSticky fsr_button fsr_mouseover_accept"},onFocus:function(){this.className="fsr_closeSticky fsr_button fsr_mouseover_accept"
},onMouseout:function(){this.className="fsr_closeSticky fsr_button fsr_accept"},onBlur:function(){this.className="fsr_closeSticky fsr_button fsr_accept"
